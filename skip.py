#!/usr/bin/env python3
"""
Skip Bot v2 - Multi-Platform Optimized
Auto-detect: Termux | Linux | Windows
"""
import os
import sys
import subprocess
...
class SkipBot:
    ...
    def setup_env(self):
        """Setup environment variables per OS"""
    ...
    def try_setup_deps(self):
        """Setup dependencies - optimized per platform"""
        if self.os_info['platform'] == 'termux':
            self.setup_termux()
        elif self.os_info['platform'] == 'windows':
            self.setup_windows()
    ...
    def setup_termux(self):
        """Setup untuk Termux - minimal deps"""
    ...
    def setup_linux(self):
        """Setup untuk Linux - full features"""
